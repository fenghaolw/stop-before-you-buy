  ...
  describe('findGameInLibraries', () => {
    it('should find a game in libraries', () => {
      const libraries = {
        ...
        epic: [{ id: '3', title: 'Red Dead Redemption 2', platform: 'epic' as Platform }],
        gog: [{ id: '4', title: "Baldur's Gate 3", platform: 'gog' as Platform }],
      };
    ...
    it('should return not found for non-existent game', () => {
      const libraries = {
        steam: [{ id: '1', title: 'The Witcher 3', platform: 'steam' as Platform }],
        epic: [],
        gog: [],
      };
