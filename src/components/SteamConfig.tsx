...
export const SteamConfig = () => {
  ...
  const handleAuthenticate = async () => {
    ...
    try {
      chrome.runtime.sendMessage({ action: 'authenticateWithSteam' }, response => {
        if (response.success) {
  ...
  const handleClearAuth = async () => {
    ...
    try {
      chrome.runtime.sendMessage({ action: 'clearSteamAuth' }, response => {
        if (response.success) {
      ...
      <div className="config-section">
        ...
        {isAuthenticated ? (
          <div className="auth-status authenticated">
            ...
            <button onClick={handleClearAuth} disabled={isLoading} className="clear-auth-btn">
